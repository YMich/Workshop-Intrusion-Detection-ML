...
def save_test_plots(
    ...
    ax.set_title("LITEMV - Test Confusion Matrix")
    fig.tight_layout()
    ...
    ax.set_title("LITEMV - Test Precision-Recall")
    fig.tight_layout()
    ...
    ax.set_ylabel("Count")
    ax.set_title("LITEMV - Test Probability Distribution")
    ax.legend()
    fig.tight_layout()
