...
ARTIFACT_ROOT = PROJECT_ROOT / "artifacts" / "models_same_hyper" / "LITEMV"
RESULT_ROOT = PROJECT_ROOT / "results" / "models_same_hyper" / "LITEMV"
...
_SPLITTER_CANDIDATES = [
    MODEL_DIR,
    SRC_ROOT / "models_same_hyper" / "LSTM",
    SRC_ROOT / "models_same_hyper_improved_final" / "LSTM",
]
