...
def main():
    ...
    print("=" * 90)
    print("AUTOENCODER O3 - MSE TRAINING LOSS")
    print("=" * 90)
    print(
    ...
    print(
        "O3 rule: retain bottleneck_dim=4 and change training loss from Huber to MSE "
        "only; keep LR=0.002, L2=1e-5, noise=0.02, batch=256 and Top-5 MSE "
        "score fixed; recalibrate threshold on O3 validation only."
    )

    if not args.evaluation_only:
        print("\nPHASE 1 - O3 TRAINING / VALIDATION / THRESHOLD CALIBRATION")
    ...
    print("\nPHASE 2 - O3 FINAL TEST EVALUATION")
