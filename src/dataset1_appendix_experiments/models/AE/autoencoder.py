...
# Isolated Dataset-1 appendix outputs.
ARTIFACT_ROOT = PROJECT_ROOT / "artifacts" / "dataset1_appendix" / "models" / "AE"
RESULT_ROOT = PROJECT_ROOT / "results" / "dataset1_appendix" / "models" / "AE"
...
def save_final_configuration() -> None:
    ...
    payload = {
        "scope": "frozen_shared_D2_D3_applied_to_D1",
