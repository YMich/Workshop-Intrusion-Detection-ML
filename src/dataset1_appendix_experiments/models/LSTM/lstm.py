...
# Dataset-1 appendix experiment only. The final D2/D3 source tree is untouched.
DATASET_PATHS = {
    "dataset1": INGESTED_ROOT / "dataset1_ingested.csv",
}
BENCHMARK_DATASETS = tuple(DATASET_PATHS.keys())

# Isolated appendix namespace so no final D2/D3 artifacts/results can be overwritten.
FINAL_NAMESPACE = "dataset1_appendix"
ARTIFACT_ROOT = PROJECT_ROOT / "artifacts" / FINAL_NAMESPACE / "models" / "LSTM"
RESULT_ROOT = PROJECT_ROOT / "results" / FINAL_NAMESPACE / "models" / "LSTM"
SHARED_SPLIT_ROOT = PROJECT_ROOT / "artifacts" / FINAL_NAMESPACE / "splits"
...
SHARED_SEARCH_RESULT_DIR = RESULT_ROOT / "shared_hyperparameter_selection"
        ...
        json.dump(
            {
                ...
                "benchmark_datasets": list(BENCHMARK_DATASETS),
                "hyperparameter_scope": "frozen D2/D3 shared values applied unchanged to Dataset 1",
                "hyperparameter_selection": (
                    "frozen final shared D2/D3 configuration; no re-tuning during final training"
                ),
...
def train_benchmark_datasets(force_resplit: bool = False) -> None:
    """Train Dataset 1 using the frozen final D2/D3 LSTM hyperparameters."""
    print("\n" + "=" * 90)
