...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Dataset-1 appendix LSTM using the frozen final D2/D3 configuration: retain the accepted "
...
def main():
    ...
    print(
        "Hyperparameter rule: use the frozen shared D2/D3 hyperparameters unchanged on Dataset 1; "
