...
ARTIFACT_ROOT = PROJECT_ROOT / "artifacts" / "dataset1_appendix" / "models" / "IF"
RESULT_ROOT = PROJECT_ROOT / "results" / "dataset1_appendix" / "models" / "IF"
...
# Shared D2/D3 Isolation Forest hyperparameters selected before optimization and
# held fixed during O1-O4. O1 was the only retained optimization.
FINAL_IF_PARAMS = {
    "n_estimators": 200,
    "max_samples": 512,
    "contamination": "auto",
...
def train_dataset(dataset_name: str, force_resplit: bool = False) -> dict:
    ...
    with (artifact_dir / "training_strategy.json").open("w", encoding="utf-8") as handle:
        json.dump(
            {
                "final_retained_optimization": "O1_feature_pruning",
                ...
                "frozen_D2_D3_hyperparameters_applied_to_D1": True,
