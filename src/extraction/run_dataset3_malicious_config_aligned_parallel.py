...
from pipeline_config import (
    ...
    DATASET3_MALICIOUS_PARALLEL_CIC_ROOT,
    MTA_CONFIG_JSON,
...
INPUT_DIR = DATASET3_MALICIOUS_INPUT_DIR
PARALLEL_CIC_ROOT = DATASET3_MALICIOUS_PARALLEL_CIC_ROOT
FINAL_OUTPUT_DIR = DATASET3_MALICIOUS_OUTPUT_DIR
...
def main() -> None:
    run_config_based_malicious_extraction(
        ...
        # Preserve Dataset 3's original union of exact + stem matches.
        exact_match_short_circuit=False,
        print_config_grouping_check=True,
    )
