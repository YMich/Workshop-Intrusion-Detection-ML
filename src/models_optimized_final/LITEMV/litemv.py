...
ARTIFACT_ROOT = PROJECT_ROOT / "artifacts" / "models_optimized_final" / "LITEMV"
RESULT_ROOT = PROJECT_ROOT / "results" / "models_optimized_final" / "LITEMV"
SHARED_SPLIT_ROOT = PROJECT_ROOT / "artifacts" / "splits"

# Reuse the final shared source-aware splitter from this final model tree.
